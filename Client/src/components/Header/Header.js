  ...
  //  const [notifications, setNotifications] = useState([])
    ...
    const content = (
        <ul className='sub-content-profile'>
            <li className='view-profile' onClick={profileVisible}>Xem trang cá nhân</li>
          <li className='btn-logout' onClick={()=>signOut(auth)}>Đăng xuất</li>
        </ul>
      );
  return (
    <div className='header-container'>
        <h1 className='header-logo' onClick={()=>reLoadPage()}>Mysocial</h1>
