  ...
  return (
    <div>
        ...
        <div className="pro-info">
            ...
            {btnFollowVisible ? <button className='btn-unfollow' onClick={handleUnFollow}>Bỏ theo dõi</button> : <button className='btn-follow' onClick={handleFollow}>Theo dõi</button>}
